...
public class PlanetComponent extends ComponentType {
    ...
    /**
     * @param chanceForCivilization
     *            the chanceForCivilization to set
     */
    ...
    /**
     * @param chanceForBacterial
     *            the chanceForBacterial to set
     */
    ...
    /**
     * @param cHANCE_ANchanceForAnimalLifeIMAL
     *            the chanceForAnimalLife to set
     */
    ...
    /**
     * @param chanceToExtractWater
     *            the chanceToExtractWater to set
     */
    ...
    /**
     * @param chanceToExtractOxygen
     *            the chanceToExtractOxygen to set
     */
    ...
    /**
     * @param chanceToFindFood
     *            the chanceToFindFood to set
     */
    ...
    /**
     * @param chanceForVegetation
     *            the chanceForVegetation to set
     */
