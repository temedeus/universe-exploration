...
/**
 * Describes the lifeforms present in the given planet. LifeformLevel enumeration
 ...
 */
public enum LifeformLevel {
    CIVILIZED("TITLE_LIFEFORMS_CIVILIZED", 4) {
        /*
         * (non-Javadoc)
         *
         * @see com.universe.exploration.survey.LifeformLevel#
    ...
    LifeformLevel(String localKey, int rank) {
