...
public enum LocalEn {
    ...
    TITLE_CREWMEMBER_DETAILS("Crew member details"),
    ...
    // General terms. Should be safe to use all around as these should not
    // change (or you are attempting to do something wrong).
    GENERAL_YES("Yes"),
    GENERAL_NO("No"),
    GENERAL_NONE("None"),
