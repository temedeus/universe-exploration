...
public enum LocalKey {
	...
	TITLE_CREWMEN_LEFT("TITLE_CREWMEN_LEFT"),
	TITLE_AIR("TITLE_AIR"),
	TITLE_WATER("TITLE_WATER"),
	TITLE_FOOD("TITLE_FOOD"),
	TITLE_POWER("TITLE_POWER"),
	TITLE_SURVEY_TEAM_SURVIVED("TITLE_SURVEY_TEAM_SURVIVED"),
	
	SUBHEADER_ORBITAL_RADIUS("SUBHEADER_ORBITAL_RADIUS"),
	SUBHEADER_PRESENT_LIFEFORMS("SUBHEADER_PRESENT_LIFEFORMS"),
	SUBHEADER_WATER_FOUND("SUBHEADER_WATER_FOUND"),
	SUBHEADER_FOOD_FOUND("SUBHEADER_FOOD_FOUND"),
	SUBHEADER_OXYGEN_PRESENT("SUBHEADER_OXYGEN_PRESENT"),

	// Label texts.
	LABEL_NO_PLANETS_FOUND("LABEL_NO_PLANETS_FOUND"),
	LABEL_CREWMEN_COUNT("LABEL_CREWMEN_COUNT"),
	LABEL_PLANET_SELECTION("LABEL_PLANET_SELECTION"),
	
	// description texts.
	DESC_HYPERSPACE_JUMP("DESC_HYPERSPACE_JUMP"),
	DESC_PLANET_TYPE("DESC_PLANET_TYPE"),
	DESC_HYPERSPACE_JUMP_COMMENCED("DESC_HYPERSPACE_JUMP_COMMENCED"),
	...
	BTN_OK("BTN_OK"),
	BTN_HYPERSPACE_JUMP("BTN_HYPERSPACE_JUMP"),
	BTN_MIN_VOLUME("BTN_MIN_VOLUME"),
	BTN_MAX_VOLUME("BTN_MAX_VOLUME"),
	
	// Generic terms
	GENERIC_AIR("GENERIC_AIR"),
	...
	GENERIC_LIQUID_WATER("GENERIC_LIQUID_WATER");
