...
/**
 * <p>Emulates {@link DataPair}.</p>
 * <p>Problem with running unit tests is the static class that generates Skin objects. If you figure out how to mock
 * those classes or any other way to run unit tests, this class can be removed. In a sense I suppose this class
 * is theoretically a "mock" of a kind?</p>
